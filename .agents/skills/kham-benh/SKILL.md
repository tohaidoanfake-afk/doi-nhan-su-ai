...
```bash
node ".agents/skills/kham-benh/bo-kham/kham.mjs" o <phiên>
```
...
```bash
node ".agents/skills/kham-benh/bo-kham/kham.mjs" moi
```
...
```bash
node ".agents/skills/kham-benh/bo-kham/kham.mjs" dap <phiên> 3                  # ô bấm chọn — ghi số thứ tự
node ".agents/skills/kham-benh/bo-kham/kham.mjs" dap <phiên> 3,6                # ô chọn nhiều
node ".agents/skills/kham-benh/bo-kham/kham.mjs" dap <phiên> 12                 # ô đếm số
node ".agents/skills/kham-benh/bo-kham/kham.mjs" dap <phiên> "kể nguyên văn…"   # ô kể bằng lời
node ".agents/skills/kham-benh/bo-kham/kham.mjs" bo  <phiên>                    # bí, bỏ qua
node ".agents/skills/kham-benh/bo-kham/kham.mjs" lui <phiên>                    # sửa câu vừa rồi
```
...
```bash
node ".agents/skills/kham-benh/bo-kham/kham.mjs" quet <phiên>
```
...
```bash
node ".agents/skills/kham-benh/bo-kham/kham.mjs" quet <phiên>    # đọc lại toàn bộ tín hiệu
node ".agents/skills/kham-benh/bo-kham/kham.mjs" soan <phiên>    # sinh kham-ra/<…>/de-xuat.md
```

Rồi **đọc `.agents/skills/kham-benh/bo-kham/luat-ke-don.md` TRỌN VẸN** và kê đơn theo đúng luật trong đó. Đọc kèm các trang bản khám tự liệt kê ở dòng *"Trang wiki bắt buộc đọc"*.
