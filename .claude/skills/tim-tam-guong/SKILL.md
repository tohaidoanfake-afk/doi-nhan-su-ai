...
**Đầu ra về:** `wiki/tam-guong-suu-tam.md`. Chưa có trang đó thì dựng theo khuôn đi kèm `.claude/skills/tim-tam-guong/khuon/tam-guong-suu-tam.md`, ghi qua `/nap-kho`.
